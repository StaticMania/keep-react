...
const AccordionAlwaysOpen = () => {
  return (
    <Accordion alwaysOpen={true} collapseAll={false}>
      <Accordion.Panel>
      ...
      <Accordion.Panel>
        ...
        <Accordion.Content>
          <p className="mb-2 text-gray-500 dark:text-gray-400">
            keep Design is first conceptualized and designed using the Figma
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Check out the
            <a
              href="https://keep Design.com/figma/"
              className="text-blue-600 hover:underline dark:text-blue-500"
            >
              Figma design system
            </a>
            based on the utility style from Tailwind CSS and components from
            keep Design.
          </p>
        </Accordion.Content>
      </Accordion.Panel>
      <Accordion.Panel>
        <Accordion.Title>
          What are the differences between keep Design and Tailwind UI?
        </Accordion.Title>
        <Accordion.Content>
          <p className="mb-2 text-gray-500 dark:text-gray-400">
            The main difference is that the core components from keep Design are
            open source under the MIT license, whereas Tailwind UI is a paid
            product. Another difference is that keep Design relies on smaller
