...
<CodePreview github="Typography" code={HeadingCode} activeTab={1}>
  <Heading />
</CodePreview>

Utilities for controlling the font size of an element.

<TypographyTable typoType="heading" />

## Body Typography

Elevate the readability of your text with the Body Typography component in Keep React.

<CodePreview github="Typography" code={BodyTypoCode} activeTab={1}>
  <BodyTypo />
</CodePreview>

Utilities for controlling the font size of an element.

<TypographyTable typoType="body" />

## Display Typography

Make a visual impact with the Display Typography component in Keep React.

<CodePreview github="Typography" code={DisplayCode} activeTab={1}>
  <Display />
</CodePreview>

Utilities for controlling the font size of an element.

<TypographyTable typoType="display" />
