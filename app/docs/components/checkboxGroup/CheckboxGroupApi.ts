export const checkboxGroupApiData = [
  {
    ...
    propsDescription: 'Specifies the type of checkbox style: square or circular.',
    default: 'square',
  },
  {
    id: 2,
    ...
    propsDescription: 'Specifies the position of the checkbox relative to the label.',
    default: 'left',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    propsType: 'string',
    propsDescription: 'Additional description or information about the checkbox group.',
