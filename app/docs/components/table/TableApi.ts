export const tableApiData = [
...

  {
    ...
    propsType: 'boolean',
    default: 'false',
    propsDescription: 'Indicates if checkboxes should be displayed in the table.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    propsType: 'ReactNode',
    default: 'content',
    propsDescription: 'Child components and content to be placed within the table.',
  },
  {
    id: 6,
    propsName: 'striped',
    propsType: 'boolean',
    default: 'false',
    propsDescription: 'Applies alternating background colors to table rows for better readability.',
  },
]
