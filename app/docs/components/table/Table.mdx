...
<CodeHighlightPreview code={DefaultTableCode}>
  <DefaultTable />
</CodeHighlightPreview>

## Product Table

<CodeHighlightPreview code={ProductTableCode}>
  <ProductTable />
</CodeHighlightPreview>

## Orders Table

<CodeHighlightPreview code={OrdersTableCode}>
  <OrdersTable />
</CodeHighlightPreview>

## Teams Table

<CodeHighlightPreview code={TeamTableCode}>
  <TeamTable />
</CodeHighlightPreview>
