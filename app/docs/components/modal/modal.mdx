...
} from "./variant/ConfirmationModal";
...
<CodePreview code={DefaultModalCode}>
  <DefaultModal />
</CodePreview>
...
<CodePreview code={ConfirmationModalCode}>
  <ConfirmationModal />
</CodePreview>
...
<CodePreview code={HistoryModalCode}>
  <HistoryModal />
</CodePreview>
...
<CodePreview code={ModalPositionCode}>
  <ModalPosition />
</CodePreview>
...
<CodePreview code={SizesOfModalCode}>
  <SizesOfModal />
</CodePreview>
...
<CssThemePreview code={useTheme().theme.modal} />
