...
import { drawerAPIData, drawerContentAPIData } from './DrawerApi'
...
<ComponentApi data={drawerContentAPIData} />

## Reference

Our drawer component is built using the `@radix-ui/react-dialog` package. For more information , follow the documentation [@radix-ui/react-dialog](https://www.radix-ui.com/primitives/docs/components/dialog#api-reference).
