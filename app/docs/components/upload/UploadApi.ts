export const uploadApiData = [
  ...
  },
  {
    ...
    propsType: 'boolean',
    propsDescription: 'Indicates whether to display a progress bar during file upload.',
    default: 'false',
  },
  {
    id: 5,
    ...
    propsDescription: 'Sets the visual style of the progress bar based on the upload status.',
    default: 'pending',
  },
  {
    id: 6,
