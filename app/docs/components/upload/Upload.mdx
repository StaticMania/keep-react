...
<CodeHighlightPreview code={DefaultUploadCode}>
  <DefaultUpload />
...
<CodeHighlightPreview code={HorizontalUploadCode}>
  <HorizontalUpload />
</CodeHighlightPreview>
...
<CodeHighlightPreview code={SingleUploadCode}>
  <SingleUpload />
</CodeHighlightPreview>
...
<CodeHighlightPreview code={DisabledUploadCode}>
  <DisabledUpload />
</CodeHighlightPreview>
