...
const LineChartType = () => {
  ...
  return (
    <ResponsiveContainer width="100%" height={350}>
      <LineChart data={data}>
        <XAxis dataKey="name" stroke="#8897AE" strokeWidth={0.5} tickSize={10} />
        <YAxis tickSize={10} dataKey="price" stroke="#8897AE" strokeWidth={0.5} />
...
export { LineChartType, LineChartTypeCode }
