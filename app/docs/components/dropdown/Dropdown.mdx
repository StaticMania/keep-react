...
<CodeHighlightPreview code={DefaultDropdownCode}>
  <DefaultDropdown />
...
<CodeHighlightPreview code={DropdownWithIconCode}>
  <DropdownWithIcon />
</CodeHighlightPreview>
...
<CodeHighlightPreview code={CustomDropdownCode}>
  <CustomDropdown />
</CodeHighlightPreview>
...
<CodeHighlightPreview code={DropdownTriggerCode}>
  <DropdownTrigger />
</CodeHighlightPreview>
