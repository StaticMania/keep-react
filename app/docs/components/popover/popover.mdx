...
<CodeHighlightPreview code={DefaultPopoverCode} className="bg-metal-50">
  <DefaultPopover />
...
<CodeHighlightPreview code={CardPopoverCode} className="bg-metal-50">
  <CardPopover />
</CodeHighlightPreview>
...
<CodeHighlightPreview code={IconPopoverCode} className="bg-metal-50">
  <IconPopover />
</CodeHighlightPreview>
