...
<CodePreview github="Popover" code={DefaultPopoverCode} className="bg-metal-50">
  <DefaultPopover />
</CodePreview>
...
<CodePreview github="Popover" code={CardPopoverCode} className="bg-metal-50">
  <CardPopover />
</CodePreview>
...
<CodePreview github="Popover" code={IconPopoverCode} className="bg-metal-50">
  <IconPopover />
</CodePreview>
