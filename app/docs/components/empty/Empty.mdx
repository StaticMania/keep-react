...
import { emptyTitleAPI, emptyDescriptionAPI } from './EmptyApi'
...
Explore the available props for the `<EmptyTitle/>` component

<ComponentApi data={emptyTitleAPI} />

Explore the available props for the `<EmptyDescription/>` component

<ComponentApi data={emptyDescriptionAPI} />
