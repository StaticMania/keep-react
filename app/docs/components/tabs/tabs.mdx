...
<CodeHighlightPreview code={DefaultTabsCode} className="bg-metal-50 dark:bg-[#0D1015]">
  <DefaultTabs />
</CodeHighlightPreview>

## Tabs With Icon

<CodeHighlightPreview code={TabsWithIconCode} className="bg-metal-50 dark:bg-[#0D1015]">
  <TabsWithIcon />
</CodeHighlightPreview>
...
<CodeHighlightPreview code={VerticalTabCode} className="bg-metal-50 dark:bg-[#0D1015]">
  <VerticalTab />
</CodeHighlightPreview>
