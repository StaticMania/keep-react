...
const ColorsOfProgress = () => {
  return (
    <div className="flex w-5/6 flex-col gap-2 p-4">
      <div className="text-body-4 font-medium text-primary-500">Blue</div>
      ...
      <div className="text-body-4 font-medium text-error-500">Red</div>
      ...
      <div className="text-body-4 font-medium text-success-500">Green</div>
      ...
      <div className="text-body-4 font-medium text-warning-500">Yellow</div>
      ...
      <div className="text-body-4 font-medium text-indigo-500">Indigo</div>
      ...
      <div className="text-body-4 font-medium text-purple-500">Purple</div>
