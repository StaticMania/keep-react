...
<CodeHighlightPreview code={DefaultButtonGroupCode}>
  <DefaultButtonGroup />
...
<CodeHighlightPreview code={ButtonGroupWithIconCode}>
  <ButtonGroupWithIcon />
</CodeHighlightPreview>
...
<CodeHighlightPreview code={ButtonGroupWithOnlyIconCode}>
  <ButtonGroupWithOnlyIcon />
</CodeHighlightPreview>

## Reference

To access the available props for button and customize their themes, please follow this documentation [Button](https://react.keepdesign.io/docs/components/button#api-reference) .
