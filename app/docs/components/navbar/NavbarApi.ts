export const NavbarApiData = [
  {
    ...
    propsName: 'fluid',
    propsType: 'boolean',
    propsDescription: 'Determines whether the navbar should be fluid or fixed-width.',
    default: 'false',
  },
  {
    id: 3,
    propsName: 'rounded',
    propsType: 'boolean',
    propsDescription: 'Specifies whether the navbar should have rounded corners.',
    default: 'false',
  },
  {
    id: 4,
    propsName: 'border',
    propsType: 'boolean',
    propsDescription: 'Controls whether a border should be added to the navbar.',
    default: 'false',
  },
  {
    id: 5,
