export const statisticApiData = [
  {
    ...
    propsType: 'boolean',
    propsDescription: 'Displays a dollar sign or currency symbol, if applicable.',
    default: 'false',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    propsName: 'children',
    propsType: 'ReactNode',
    propsDescription: 'Child components and content to be placed within the statistic component.',
    default: 'Content',
  },
  {
    id: 5,
