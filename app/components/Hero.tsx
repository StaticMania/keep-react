          ...
          <div className="w-full lg:col-span-1">
            <div className="mt-5">
              ...
              <div className="flex flex-col items-start gap-3 lg:flex-row lg:items-center lg:gap-5">
                <div className="inline-flex w-[270px] items-center justify-between divide-x-2 divide-metal-100 rounded-lg border border-metal-200 bg-white px-3.5 py-3 dark:bg-metal-800">
                  <span className="text-body-4 font-normal text-metal-500 dark:text-metal-300">
