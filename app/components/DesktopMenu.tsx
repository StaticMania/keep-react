    ...
    <>
      ...
      <div className="hidden items-center gap-3 laptop:flex">
        ...
        <Link
          ...
          className="rounded-lg bg-metal-900 px-4 py-2.5 text-body-4 font-medium capitalize text-white transition-all duration-300 hover:bg-metal-800 dark:bg-white dark:text-metal-900">
          get started
        </Link>
        <ThemeSwitcher />
      </div>
