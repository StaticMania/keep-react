      ...
      <div className="mx-auto max-w-7xl px-6 2xl:px-0">
          ...
          {routes.slice(0, 20).map((item) => {
            ...
            return (
              <Link
                href={href}
                key={id}
                className="flex items-center gap-2.5 rounded-xl border border-dashed border-metal-200 bg-white px-5 py-2.5 transition-all duration-300 hover:bg-metal-900 hover:text-white dark:bg-metal-800 md:px-8 md:py-4">
                {Icon && <Icon size="18" />}
                {item.name}
              </Link>
            )
        ...
        <div className="mt-9 flex items-center justify-center">
          <Link
            ...
            className="flex items-center gap-2 rounded-lg border border-dashed border-metal-200 bg-white px-6 py-2.5 transition-all duration-300 hover:bg-metal-900 hover:text-white dark:bg-metal-800">
