...
export const Content = forwardRef<HTMLDivElement, floatingArrow>(
  (
    { children, className, width, height, tipRadius, staticOffset, fill = '#fff', stroke, strokeWidth, d, ...props },
    ...
    return (
      isOpen && (
        <div
          {...props}
          className={cn('max-w-[263px] rounded-xl border border-metal-100 bg-white px-2.5 py-2', className)}
