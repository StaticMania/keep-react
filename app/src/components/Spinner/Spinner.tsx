...
const fillClasses = {
  ...
  secondary: 'fill-metal-900 dark:fill-white',
...
const Spinner = forwardRef<HTMLDivElement, SpinnerProps>(({ color = 'primary', className }, ref) => {
  return (
    <div ref={ref} aria-label="Loading..." role="status">
      <svg
        className={cn('size-8 animate-spin', fillClasses[color as keyof SpinnerColors], className)}
        viewBox="3 3 18 18">
        <path
