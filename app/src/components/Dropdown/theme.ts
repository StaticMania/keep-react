...
export const dropdownTheme: DropdownInterface = {
  action:
    'inline-block cursor-pointer select-none rounded-lg border border-metal-200 dark:border-metal-900 dark:bg-metal-900 bg-metal-900 py-2 px-3.5 text-body-5 font-normal text-white',
