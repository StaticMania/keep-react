...
export const tabsTheme: TabsTheme = {
  ...
  content: {
    base: 'text-body-4 font-normal text-metal-500',
    vertical: {
      on: 'basis-3/4',
      off: '',
    },
  ...
  item: {
    base: 'border-transparent bg-transparent px-4 py-3 text-body-4 font-medium hover:bg-primary-50 hover:text-primary-500',
    vertical: {
