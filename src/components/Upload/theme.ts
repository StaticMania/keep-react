...
export const uploadTheme: keepUploadTheme = {
  ...
  uploadFailed: {
    ...
    root: {
      ...
      confirmBox: {
        ...
        restart: 'flex h-6 w-6 items-center justify-center rounded-full bg-error-50 text-slate-500',
  ...
  uploadPending: {
    ...
    root: {
      ...
      confirmBox: {
        base: 'flex items-center gap-5',
        pause: 'flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 text-slate-500',
        dismiss: 'flex h-6 w-6 items-center justify-center rounded-full bg-error-50',
      },
    },
    progress: {
