...
const meta: Meta<typeof Sidebar> = {
  ...
  decorators: [
    (Story) => {
      return (
        <div className="max-w-xs shadow-large">
          <Story />
        </div>
      )
    },
      ...
      <Sidebar.Items>
        ...
        <Sidebar.CTA>
          <div className="mb-3 flex items-center">
            ...
            <button
              aria-label="Close"
              className="-m-1.5 ml-auto inline-flex h-6 w-6 rounded-lg bg-primary-50 p-1 text-primary-900 hover:bg-primary-200 focus:ring-2 focus:ring-blue-400 dark:bg-primary-900 dark:text-primary-400 dark:hover:bg-primary-800"
              type="button">
              <svg
                aria-hidden={true}
                className="h-4 w-4"
          ...
          <a
            className="text-body-5 text-primary-900 underline hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-300"
            href="#">
