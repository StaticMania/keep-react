...
export const treeTheme: keepTreeTheme = {
  base: 'list-none space-y-2  text-base font-medium text-slate-700',
  list: {
    base: 'text-base font-medium text-slate-700 select-none',
    hasChild: {
  ...
  showChildren: {
    base: 'text-base font-medium text-slate-400 select-none',
    on: '',
    off: 'hidden',
  },
